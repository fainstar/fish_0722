...
from logger import get_client_info, log_user_activity, app_logger, parse_user_activity_logs, calculate_log_statistics, get_combined_logs
from translations_handler import get_text
from fish_detector import FishDetectionSystem
from file_utils import allowed_file, clean_processed_folder, get_file_size, save_uploaded_file, move_processed_files, create_sample_image_copy
...
def register_routes(app):
    ...
    def log_viewer():
        ...
        # 計算統計數據（只用用戶活動日誌）
        user_logs = parse_user_activity_logs(log_type, date_from, date_to, ip_address)
        stats = calculate_log_statistics(user_logs)
